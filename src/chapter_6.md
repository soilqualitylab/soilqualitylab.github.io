...
We could use ANY discipline for this, martial arts is never lacking in metaphors and generally speaking we might want to spend a lot more time rolling and learning from martial arts masters *just doing drills in order to retain a degree of mobility* ... but in **today**'s topic, we will consider a slightly more intellectual example ... we can look at how AI technology is not advancing, eg understanding the importance of the [jump from Gemma 3 to Gemma 3n, which is producing a paradigm shift in on-device AI](https://docs.google.com/document/d/1RNnVCqQ9And7UUl38C6vqcaljJFg6kjIudAuPJwgmVk/edit?usp=sharing) or we can think practically about mapping out the specifics [how will we dev using ROCm/AMD paradigm OR using the Apple unified memory paradigm of M4 devices](https://g.co/gemini/share/50a763de21ea), but let's not get lost in the weeds ... this is for intellectual well-being, using AI as a mental gym or dojo ...*rolling* on the AI mats, so to speak ... as AI gets a lot more efficient and picking up speed as it advances.
