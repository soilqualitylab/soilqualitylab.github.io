...
Today's topic is primarily about mitochonrial assessment.  The conventional one-size-fits-all approach overlooks the significant genetic variability in mitochondrial function ... there are MUCH BETTER lab-based biomarkers, eg [Mitome](https://www.mito.me/) might be the best example of these BETTER LAB BASED APPROACHES and real-world functional tests, which are things like the Holter heart rate variability monitors or ambulatory electrocardiogram, ie it's about VARIABILITY in different locations, as you go through the day -- this is NOT fitness watch territory, if only because fitness watches don't really have adequate contact with your skin ... other functional tests include [VO2max trends](https://exrx.net/Calculators/Rockport), consistently sampled every day for months or **OVER TIME**, ie NOT one day in lab with VO2max instrumentation, recovery time tracking **over time**, blood glucose monitoring **over time** and ketone monitoring **over time**. Based on some preliminary work to develop context for the AI to assess the lab-based bio-markert, an AI was prompted to:
...
### Day 35 - July 5, 2025 | Intellectual Wellbeing: Developing Elite Skills and Disciplines
Consider the example of Meta's AI researchers, such as Bansal, Zhao, Bi, Yu, Beyer, Kolesnikov, Rae, Ren, Sun, Pobar, and Schalkwyk. These individuals have made significant contributions to breakthrough AI systems like ChatGPT, GPT-4, Gemini, Vision Transformer, Gopher, Chinchilla, YouTube Shorts algorithms, Waymo's perception systems, and Google Voice Search. The goal our request of AI today is understand common attributes and synthesize a comprehensive understanding of the skills and disciplines that contribute to these 11 researchers' success. The AI was prompted to:
