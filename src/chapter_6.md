...
#### Practically Applied Neuroscience and Lessons Of Contemplative Practices 

*Unfortunatly the AI claimed to be experiencing unusually high traffic and to be at full capacity. I will be trying again later* ... but I wanted to explain why this above material is as important as it is to me IN A PRACTICAL SENSE ... in order to *connect the dots* between the hermetic wellness and the practical application of neuroscience and contemplative practices, I ATTEMPTED TO prompt an AI, so that it produced a nice, concise, practical summary of this work ... although anyone who's been following along with my different projects, eg MelonCave podcast or the old AncientGuyFitness podcast ... will know that I have been working on this for a long time ... so I sort of know too much to SUCCINCTLY connect the dots for people new to the material, ie AI are good summarizing and regurging the cliches that we take for granted. The prompt for the AI goes something like the following:
