...
- [LessGovt.DEV](https://ancientguy.github.io/#the-road-to-continuous-ressurection-and-renewal-based-on-the-beatitudes) ... DEVELOPing LIVES and cultures that do not worship government or expect magic entitlements or funding from government ... this begins and maybe ends with the topic of education, teaching children from 3 or on to be autodidactic and to generally inculcate a self-actualizing, self-developing society that values relationships and family and friendships ... RATHER that pointing to the coercively violent taxation of government to provide the magic entitlements.  This includes defense and security ... every single person should spend approximately 5% of each day thinking about self-defense, security and the security of their neighbors, friends and family members ... and that means improving PRACTICAL empathy, awareness, listening and PERSONAL one-on-one generosity.

- [TRIZ.tips](https://engrco.gitlab.io/triz.tips/) is about knowledge engineering and the development of accelerated decision support systems. Decision support systems rely upon past intelligence gathered, but but technological intelligence gathering process is a continuous ongoing process. This led to [DRAIN.tips](https://github.com/draintips) or monkeying around with sewer drain intelligence ... and that finally led to [ArtificialDad.net](https://ancientguy.github.io/#the-road-to-continuous-ressurection-and-renewal-based-on-the-beatitudes) ... which is effectively about a APPLIED form of Resurrection Lifestyles of AncientGuy... in this example, Artificial Dad is about making up for the Dad who didn't teach you everything about fixing all of your stuff ... so practically, at first, it's about AI-assisting professional level advice in the HVAC trade... featuring an OFFSITE old geezer Dad HVAC tech [a ***resurrected has been***] looking at what the technician is seeing and giving AI-assisted advice as the tech is trying to do the repair actually seeing through META goggles or similar sorts of eyewear that includes a camera and connection to a smartphone 
...
- [Nanotoolworks.com](https://nanotoolworks.github.io/) ... aims at overcoming the constraints, significant cost barriers in the tooling, jigs, fixtures, equipment for 13 different areas of nanotechnology ... [Nanolithography](https://nanotoolworks.github.io/nested/1.md), [Nanomechanics](https://nanotoolworks.github.io/nested/2.html), [Nanocharacterization](https://nanotoolworks.github.io/nested/3.html), [Nanoelectronics](https://nanotoolworks.github.io/nested/4.html), [Nanophotonics](https://nanotoolworks.github.io/nested/5.html), [Nanobiotechnology](https://nanotoolworks.github.io/nested/6.html), [Nanomaterials](https://nanotoolworks.github.io/nested/7.html), [Nanosensors](https://nanotoolworks.github.io/nested/8.html), [Nanofluidics](https://nanotoolworks.github.io/nested/9.html), [Nanomagnetics](https://nanotoolworks.github.io/nested/10.html), [Nanotoxicology](https://nanotoolworks.github.io/nested/11.html), [Nanomedicine](https://nanotoolworks.github.io/nested/12.html), and [Molecular Nanotechnology](https://nanotoolworks.github.io/nested/13.md)... the origin of nanotoolworks goes way to root cause investigations things related to [ENGR.co](https://engrco.gitlab.io/) and the discipline of compounded improvement.

- SQL.ag ... soil quality laboratory for agricultural soil testing and bioremediation ... this includes things like [Rheum.Life](https://github.com/rheumLIFE) and herbal medicine as well as the joy of chaos gardening and growing different things with [WhoresRadish.com](https://engrco.gitlab.io/whoresradish/)

- Salebarn ... this started being about accelerating the negotiations for events and marketplaces for buying / selling / trading agricultural products ... branched into [guerilla marketing strategies](https://github.com/AUCT-us) and then customer relationship databases and generally increasing an awareness of [where the crowd is going](https://github.com/Crowdliness)

- [CloudKernelOS](https://github.com/CloudKernelOS) ... MLIR compiler frameworks, heterogenous computing and making compute, rather than devices, ubiquitous and secure ... but also about [annotated vectors stores of improved, specified LLMs](https://github.com/annotifyapp). Information is physical or reflected in the data available in the world we live, but knowledge or how that data is translated into something meaningful is a human thing. As a form of knowledge, science is socially applied hybrid intelligence ... as maps were replaced by GPS, science is now being defined by the applied connected, annotated intelligence of scientometry ... this scientometery must be reflected in the compiler frameworks that we use to process digital data back into some sort of meaningful representation of information that humans can use, at the moment they need to use it ... this means being genuined enveloped in a cloud of heterogenous compute, ubiquitously available at the point the of use ... it involves thinking beyond the device, the PC, the smartphone and accessing the local cloud as well as the larger global clouds.

- [Quantum Life](https://github.com/QTM-life) ... is basically about the HARD, practical science fiction of [what it take to develop stellar megastructures](https://qtm-life.github.io/Roadmap/0/) ... a mental exercise to help us BEGIN to escape the limits of our current human-scale thinking. The POINT of this whole exercise is about REMOTE VIEWING in the Big Picture sense … NOT remote viewing in the small-minded human sense, with an ego-trapped human-scale, human-centric egotistical mindset, eg of someone wanting to see what his enemies are doing OR to visit Mars as some sort of heroic pioneer … but to acknowledge the limiting aspects of the human ego upon our ability to sense the Universe, be able to VIEW the Big Picture for what everything in Universe is trying to tell us [not what humans are focused upon] … to sense the Universe at various different scales, from different points-of-view, from the particle-level to the Universal-level, as situationally appropriate.
