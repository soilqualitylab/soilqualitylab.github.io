...
*Unfortunatly the AI claimed to be experiencing unusually high traffic and to be at full capacity. So I will be trying again later and you might see an update here, unless there's some PERMANENT issue with the AI covering this topic* [***since it is kind of the core basis of some advanced Defense or Intelligence technologies***, *eg remote viewing disciplines/practices*] ... but I wanted to explain why this above material is as important as it is to me IN A PRACTICAL SENSE ... in order to *connect the dots* for people OR explain what I've been up to and WHY I've been looking at the connections between the hermetic wellness and the practical application of neuroscience and contemplative practices for some time, I ATTEMPTED TO prompt an AI, so that it produced a nice, concise, practical summary of this work ... consciousness, meditation and prayer are INFINITELY intriguing to me, but I tend to start off on some tangent that I currently enjoy, so I sort of really suck at SUCCINCTLY connecting the dots for people new to the material, ie fortunately AI are good atsummarizing and truly excel at regurgitating the well-worn cliche materials that people familiar with a topic take for granted and fail to explain. 
